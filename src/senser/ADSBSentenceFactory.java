...
public class ADSBSentenceFactory implements ADSBSentenceFactoryInterface
{
	...
	private static final String patAdsbJson = "[0-9]{10}\\.[0-9]{7}!ADS-B\\*[0-9A-F]{28}";
	...
	{		
		...
		{					
			...
			matcher.find();
			String dfca 	 = matcher.group().substring(0,2);
			String icao 	 = matcher.group().substring(2,8);
			String payload 	 = matcher.group().substring(8,22);
			String parity 	 = matcher.group().substring(22,28);
